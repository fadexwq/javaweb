...
<script type="text/javascript">
    ...
    */
    function operationFormatter(value,row,index){
        ...
        var html = "<span onclick='admin_edit("+value+")' style='cursor: pointer;color:blue' class='glyphicon glyphicon-edit'></span>&nbsp;&nbsp;&nbsp;";
...
<script type="text/javascript">
    ...
    /*管理员-增加*/
    function admin_add(){
        layer_show("添加管理","admin/add.do",800,500);
    }

    /*管理员-编辑*/
    function admin_edit(userId){
        layer_show("添加管理","admin/add.do?userId="+userId,800,500);
    }
